            ...
            <div class="breadcrumb-content">
                ...
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Herala Houseboats</li>
                    </ul>
                </nav>
            </div>
        </div>
                    ...
                    <div class="destination-item destination-4-col">
                        <div class="destination-image">
                            ...
                            <div class="destination-btn">
                                <a href="{{ route('website.houseboatspkages2', $cat->id) }}" class="btn-blue btn-red">Packages</a>
                            </div>
                        </div>
                        <div class="destination-content">
                            <h5><a href="{{ route('website.houseboatspkages2', $cat->id) }}">{{ $cat->package_type }}</a></h5>
                        </div>
                    </div>
                </div>
                @endforeach
