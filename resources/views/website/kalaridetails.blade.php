                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <li class="active"><a data-toggle="tab" href="#description">PACKAGE DETAILS</a></li>
                            <li><a data-toggle="tab" href="#timeline">ITENARARY</a></li>
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><i class="fa fa-map-marker" aria-hidden="true">{{ $packages->destination }}</i></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul>
                                                            <li><i class="fa fa-check" aria-hidden="true"></i>{{  strip_tags($packages->includes, '<a><strong><em><u><s><br><div>') }}</li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="excludes">
                                                        <ul>
                                                            <li><i class="fa fa-times" aria-hidden="true"></i>{{  strip_tags($packages->excludes) }}</li>
                                        ...
                                        <ul class="timeline">
                                            ...
                                            <li>
                                                ...
                                                <div class="direction-r">
                                                    {{ preg_replace('/&nbsp;/', '',  strip_tags($packages->Itenarary)) }}
                                                </div>
                                            </li>
                    ...
                    <div id="sidebar-sticky" class="col-md-4">
                        <aside class="detail-sidebar sidebar-wrapper">
                            <div class="sidebar-item sidebar-item-dark">
                                ...
                                <form method="POST" action="{{ route('kalaripkages.submit') }}">
                                    @csrf
                                    <div class="row">
                                ...
                                <div class="sidebar-content sidebar-slider">
                                    <div class="sidebar-package">
                                        ...
                                        <div class="destination-content sidebar-package-content">
                                            <h4><a href="{{ route('website.kalaridetail',$packages->id) }}">5 Days Honeymoon Package</a></h4>


                                            <a href="ayurveda-detail.html" class="btn-blue btn-red">Book Now</a>
                                        </div>
                                    </div>
                                    <div class="sidebar-package">
                                        <div class="sidebar-package-image">
                                        ...
                                        <div class="destination-content sidebar-package-content">
                                            ...
                                            <a href="Tour/ayurvedadetail" class="btn-blue btn-red">Book Now</a>
                                        </div>
                                    </div>
                                    <div class="sidebar-package">
                                        <div class="sidebar-package-image">
                                        ...
                                        <div class="destination-content sidebar-package-content">
                                            <h4><a href="Tour/ayurvedadetail">5 Days Honeymoon Package</a></h4>
