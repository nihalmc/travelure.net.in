            ...
            <div class="breadcrumb-content">
                ...
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="Tour/kalaripackages">Kalari Tour Packages</a></li>
                    ...
                    <div class="destination-item destination-4-col">
                        <div class="destination-image">
                            ...
                            <div class="destination-btn">
                                <a href="{{ route('website.kalaridetail', $peop->id) }}" class="btn-blue btn-red">View More</a>
                            </div>
                        </div>
                        <div class="destination-content">
                            <h5><a href="{{ route('website.kalaridetail', $peop->id) }}">{{ $peop->name }}</a></h5>
