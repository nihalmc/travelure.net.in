    ...
    <section class="breadcrumb-outer text-center">
        <div class="container">
            <div class="breadcrumb-content">
                <h2>Ayurveda Packages in Kovalam</h2>
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('website.index') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Tour Packages</a></li>
                        <li class="breadcrumb-item"><a href="Tour/ayurvedapackages">Ayurveda Packages</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Ayurveda Packages in Kovalam</li>
                    </ul>
                </nav>
            </div>
        </div>
                    ...
                    <div class="destination-item destination-4-col">
                        <div class="destination-image">
                            ...
                            <div class="destination-btn">
                                <a href="{{ route('website.ayurvedadetail', $peop->id) }}" class="btn-blue btn-red">View More</a>
                            </div>
                        </div>
                        <div class="destination-content">
                            <h5><a href="{{ route('website.ayurvedadetail', $peop->id) }}">{{ $peop->name }}</a></h5>
