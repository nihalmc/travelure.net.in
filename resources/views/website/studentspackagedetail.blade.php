                                        ...
                                        <ul class="timeline">
                                            ...
                                            <li>
                                                <div class="direction-r">
                                                    ...
                                                    {{  strip_tags($packages->Itenarary, '<a><strong><em><u><s><br><div>') }}
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><i class="fa fa-map-marker" aria-hidden="true"></i>{{ $packages->days }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="title">Destinations</td>
                                                    <td><i class="fa fa-clock-o" aria-hidden="true"></i>{{ $packages->destination }} </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul>
                                                            <li>{{  strip_tags($packages->includes, '<a><strong><em><u><s><br><div>') }}</li>
                                                        </ul>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="excludes">
                                                        <ul>
                                                            <li>{{  strip_tags($packages->excludes, '<a><strong><em><u><s><br><div>') }}</li>
                                                        </ul>
                                                    </td>
                                                </tr>
                                            </tbody>
                                ...
                                <div class="top-attractions detail-box">
                                    ...
                                    <div class="top-attraction-content">
                                        <div class="att-item clearfix">
                                            <div class="att-image">
                                                <img src=" {{asset('storage/'.$packages->accomodation->image) }}" alt="Images">
                                            </div>
                                            <div class="att-content">
                                                <div class="att-content-left">
                                                    <h4>{{ $packages->accomodation->title }}</h4>
                                                    <ul>
                                                        <li><i class="fa fa-check" aria-hidden="true"></i>{{  strip_tags($packages->accomodation->text, '<a><strong><em><u><s><br><div>') }}</li>
                    ...
                    <div id="sidebar-sticky" class="col-md-4">
                        <aside class="detail-sidebar sidebar-wrapper">
                            <div class="sidebar-item sidebar-item-dark">
                                ...
                                <form method="POST" action="{{ route('studentspkages.submit') }}">
                                    @csrf
                                    <div class="row">
                                ...
                                <div class="sidebar-content sidebar-slider">
                                    <div class="sidebar-package">
                                        ...
                                        <div class="destination-content sidebar-package-content">
                                            ...
                                            <a href="{{ route('website.studentsdetail',$packages->id) }}" class="btn-blue btn-red">Book Now</a>
                                        </div>
                                    </div>
                                    <div class="sidebar-package">
                                        <div class="sidebar-package-image">
                                            <img src="{{ asset('website/images/detailslider2.jpg') }}detailslider2.jpg" alt="Image">
                                        </div>
                                        <div class="destination-content sidebar-package-content">
                                            <h4><a href="#">5 Days Honeymoon Package</a></h4>
