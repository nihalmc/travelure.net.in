                                ...
                                <div class="top-attractions detail-box">
                                    ...
                                    <div class="top-attraction-content">
                                        <div class="att-item clearfix">
                                            <div class="att-image">
                                                <img src="{{ asset('storage/'.$packages->image) }}" alt="Images">
                                            </div>
                                            <div class="att-content">
                                                <div class="att-content-left">
                                                    <h4>{{ $packages->accomodation->title }}</h4>
                                                    <ul>
                                                        <li><i class="fa fa-check" aria-hidden="true">{{  strip_tags($packages->accomodation->text) }}</i></li>
                    ...
                    <div id="sidebar-sticky" class="col-md-4">
                        <aside class="detail-sidebar sidebar-wrapper">
                            <div class="sidebar-item sidebar-item-dark">
                                ...
                                <form method="POST" action="{{ route('internationalpkages.submit') }}">
                                    @csrf
                                    <div class="row">
