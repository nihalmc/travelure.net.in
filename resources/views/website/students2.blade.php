            ...
            <div class="breadcrumb-content">
                ...
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="Tour/studentspackages">Students Tour Packages</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Kerala Honeymoon Packages</li>
                    </ul>
                </nav>
            </div>
        </div>
                    ...
                    <div class="destination-item destination-4-col">
                        <div class="destination-image">
                            ...
                            <div class="destination-btn">
                                <a href="{{ route('website.studentsdetail', $peop->id) }}" class="btn-blue btn-red">View More</a>
                            </div>
                        </div>
                        <div class="destination-content">
                            <h5><a href="{{ route('website.studentsdetail', $peop->id) }}">{{ $peop->name }}</a></h5>
