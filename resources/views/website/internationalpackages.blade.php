                    ...
                    <div class="destination-item destination-4-col">
                        <div class="destination-image">
                            ...
                            <div class="destination-btn">
                                <a href="{{ route('website.internationalpkages2', $cat->id) }}" class="btn-blue btn-red">Packages</a>
                            </div>
                        </div>
                        <div class="destination-content">
                            <h5><a href="{{ route('website.internationalpkages2', $cat->id) }}">{{ $cat->package_type }}</a></h5>
                        </div>
                    </div>
                </div>
                @endforeach
