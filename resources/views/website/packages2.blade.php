...
@section('content')
    ...
    <section class="destinations destination-padding">
        <div class="container">
            <div class="row">
                @foreach($keralapackages as $peop)
                    ...
                    <div class="destination-item destination-4-col">
                        <div class="destination-image">
                            ...
                            <div class="destination-btn">
                                <a href="{{ route('website.packagesdetail', $peop->id) }}" class="btn-blue btn-red">View More</a>
                            </div>
                        </div>
                        <div class="destination-content">
                            <h5><a href="{{ route('website.packagesdetail', $peop->id) }}">{{ $peop->name }}</a></h5>
