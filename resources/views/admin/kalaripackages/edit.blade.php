...
<h3> Edit Kalari Packages</h3>
<div class="row container" style="">
 <script  src="{{ asset('admin/ckeditor/ckeditor.js') }}" > </script>
<form action="{{ route('kalaripackages.update' ,$packages->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-md-4">
     ...
     <div class="form-group row">
        ...
        <div class="col-md-8">
            ...
            <textarea name="PackageDetails">{{ $packages->PackageDetails }}</textarea>
...
<div class="form-group">
   ...
   <form action="{{ route('kalaripackages.destroy', $packages->id) }}" method="POST" id="deleteForm{{ $packages->id }}">
    @csrf
    @method('DELETE')
