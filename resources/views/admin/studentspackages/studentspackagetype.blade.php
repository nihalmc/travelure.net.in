...
<h1>Add Students Package Type</h1>
 <script  src="{{ asset('admin/ckeditor/ckeditor.js') }}" > </script>
<form action="{{ route('studentspackagestype.submit') }}" method="post" enctype="multipart/form-data" >
    @csrf
...
<h3>List Students Package Types </h3>
...
<thead>
                <tr>
                 ...
                 <th>Students Package Type Title</th>
                  <th>Image</th>
                   <th>Text</th>
                   <th>Order number</th>
        ...
        <tbody>
            @foreach($package_types as $cat)
                <tr>
                    ...
                    <td><a href="{{ route('studentPackage_type.edit' , $cat->id) }}">Edit</a></td>
                </tr>
            @endforeach
            </tbody>
            </table>
