...
<h1>Add Students Package Gallery Images</h1>

<form action="{{ route('studentsgalleries.submit') }}" method="post" enctype="multipart/form-data"onSubmit="return FrmSub()" >
...
<form action="{{ route('studentsgalleries.listgallery') }}" method="post"enctype="multipart/form-data">
    @csrf
<div class ="form-group row">
    <div class="col-md-2">
<label for="selectid">Select Package</label>
...
<thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                <th><a href="{{ route('studentsgalleries.deletegallery', ['id' => $package->id]) }}"  onclick="return showDeleteConfirmation({{ $package->id}})">Delete</a></th>
            </tr>
            @endforeach
