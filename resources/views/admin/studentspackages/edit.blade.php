...
<h3> Edit Students Packages</h3>
<div class="row container" style="">
 <script  src="{{ asset('admin/ckeditor/ckeditor.js') }}" > </script>
<form action="{{ route('studentspackages.update' ,$packages->id) }}" method="post" enctype="multipart/form-data">
    @csrf
   ...
   <label for="selectid">Select Package Type</label>
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
           ...
           <form action="{{ route('studentspackages.destroy', $packages->id) }}" method="POST" id="deleteForm{{ $packages->id }}">
            @csrf
            @method('DELETE')
