...
<h1>Add Kerala Package Type</h1>
 <script  src="{{ asset('admin/ckeditor/ckeditor.js') }}" > </script>
<form action="{{ route('package_types.submit') }}" method="post" enctype="multipart/form-data">
    @csrf
...
<h3>List Kerala Package Types </h3>
...
<thead>
                <tr>
                 ...
                 <th>Kerala Package Type Title</th>
                  <th>Image</th>
                   <th>Text</th>
                   <th>Order number</th>
        ...
        <tbody>
            ...
            @foreach ($package_types as $types)
             <tr>
              ...
              <th> <a href="{{ route('Package_type.edit' , $types->id) }}"> Edit </th>
