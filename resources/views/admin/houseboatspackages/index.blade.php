...
<h3>List Kerala Houseboats Packages </h3>
...
<thead>
        ...
        <tbody>
            @foreach($houseboatspackages as $peop)
            <tr>
                <td>{{ $peop->hotelname }}</td>
                ...
                <td>{{ $peop->days }}</td>
                <td>{{ $peop->accomodation->title }}</td>
                <td>{{ $peop->showinhomepage }}</td>
                <td>{{ $peop->ordernumber }}</td>
                <td>
                    <a href="{{ route('houseboatspackages.edit',  $peop->id) }}">Edit</a>
                </td>
            </tr>
        @endforeach
            </tbody>
