...
<h1>Edit Kerala Houseboats Package Type</h1>
<h3>Edit </h3>
 <script  src="{{ asset('admin/ckeditor/ckeditor.js') }}" > </script>
<form action="{{ route('houseboatspackage_type.update', $package_types->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
<div class="form-group row">

    <div class ="col-md-2">
            Kerala House Boats Package Type Title
    </div>
    <div class = "col-md-4">
   ...
   <script>
       function deletepackage_type(id) {
           if (confirm("Are you sure you want to delete this  Package Type?")) {
               window.location = "{{ url('/Packagetype/deletehouseboatspackagetype') }}/" + id;
           }
       }
   </script>
