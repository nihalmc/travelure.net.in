...
<form action="{{ route('houseboatspackages.store') }}" method="post" enctype="multipart/form-data">
    @csrf
...
<div class="form-group row">
        ...
        <div class="col-md-8">
            ...
            <textarea name="packagedetails"></textarea>
        ...
        <div class="col-md-8">
            ...
            <textarea name="roomdetails"></textarea>
